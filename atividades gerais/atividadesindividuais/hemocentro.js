...
function OP3() {
    ...
    for (let i = 0; i < sanguefiltrado.length; i++){
...
function OP4() {
    ...
    const dataFormatada = datadesejada.split('/').reverse().join('/')
    const datascelecionadas = arraycadastros.filter(cadastro => cadastro.ultimadoacao <= dataFormatada);
    console.log("----------------------")
    console.log("LISTAGEM DE BUSCA")
    console.log("----------------------")
    console.log("NOME           | PESO | IDADE | TIPO SANGUINEO | ULTIMA DOAÇÃO")
    console.log("---------------------------------------------------------------")
    for (let i = 0; i < datascelecionadas.length; i++){
        console.log(`${datascelecionadas[i].nome.padEnd(7)}| ${datascelecionadas[i].peso.padEnd(5)}| ${datascelecionadas[i].idade.padEnd(5)}| ${datascelecionadas[i].tiposanguineo.padEnd(5)}| ${datascelecionadas[i].ultimadoacao.padEnd(5)}|`)
    }
    console.log("---------------------------------------------------------------")
}
